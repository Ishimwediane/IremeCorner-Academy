...
const TrainerMessages = () => {
  ...
  return (
    <TrainerLayout title="Messages">
      <Box sx={{ height: 'calc(100vh - 150px)', display: 'flex', gap: 2 }}>
        {/* Conversations List */}
          ...
          <List sx={{ flex: 1, overflow: 'auto', p: 0 }}>
            {conversationsLoading ? (
              ...
              conversations.map((conversation) => {
                ...
                const isStudent = conversation.partner.role === 'student';
                ...
                return (
                  ...
                  >
                    <ListItemAvatar>
                      ...
                      >
                        <Avatar sx={{ bgcolor: isStudent ? '#202F32' : '#C39766' }}>
            ...
            <>
              ...
              <Box sx={{ p: 2, borderBottom: 1, borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Avatar sx={{ bgcolor: selectedConversation.partner.role === 'student' ? '#202F32' : '#C39766' }}>
                  ...
                  <Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      {selectedConversation.partner.role === 'student' && (
                        <Chip
                          label="Student"
                          size="small"
                          sx={{
