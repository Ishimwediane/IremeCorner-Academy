...
import { Box, Drawer, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Typography, Avatar, Divider, IconButton, AppBar, Toolbar, InputBase, Badge } from '@mui/material';
import {
            ...
            >
                ...
                <Drawer
                    ...
                    sx={{
                        ...
                        '& .MuiDrawer-paper': { boxSizing: 'border-box', width: DRAWER_WIDTH, bgcolor: 'white', borderRight: '1px solid #E5E7EB' },
                    }}
                >
                    {drawer}
                </Drawer>
